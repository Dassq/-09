...
if (isset($_GET['delete'])) {
    $id = (int)$_GET['delete'];
    // Попытка удалить файл ТЗ, если колонка существует
    try {
...
// Редактирование – получаем данные проекта
$edit_project = null;
if (isset($_GET['edit'])) {
    $id = (int)$_GET['edit'];
...
// Обработка добавления / обновления
$error = '';
...
// Список всех проектов для таблицы
$projects = $pdo->query("
...
<main class="container">
    ...
    <table class="admin-table">
        <thead>
            <tr><th>ID</th><th>Название</th><th>Заказчик</th><th>Дата</th><th>Действия</th></tr>
        </thead>
        <tbody>
