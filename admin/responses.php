...
if (isset($_GET['delete'])) {
    ...
    header('Location: responses.php' . (isset($_GET['project_id']) ? '?project_id=' . $_GET['project_id'] : ''));
    exit;
}
...
<body>
    ...
    <main class="container">
        ...
        <table class="admin-table">
            <thead><tr><th>ID</th><th>Проект</th><th>Исполнитель</th><th>Текст отклика</th><th>Дата</th><th>Действия</th></tr></thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td data-label="Действия"><a href="?delete=<?php echo $resp['id']; ?>&project_id=<?php echo $project_filter; ?>" onclick="return confirm('Удалить отклик?');">Удалить</a></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
